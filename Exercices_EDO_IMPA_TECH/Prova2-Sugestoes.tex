...
\title{Introducao as Equacoes Diferenciais -- Sugestoes para a Prova 2}

\begin{document}
\maketitle

\noindent{\small
Este arquivo e um banco curto para montar a segunda prova. A recomendacao
natural para uma prova com 6 questoes e escolher 3 problemas faceis, 1
problema medio-dificil, 1 problema dificil e 1 problema ultra-dificil. As
observacoes entre colchetes sao apenas para o professor e indicam o papel
sugerido de cada questao.
}

\vspace{4mm}

%=====================================================================
\section*{Problemas faceis}
%=====================================================================
...
\begin{problema}
\textbf{[Facil; Lista 4, reducao de ordem.]}
Sabendo que $y_1(t)=t$ e uma solucao em $(0,\infty)$, encontre a solucao
geral de
\[
    t^2y''-2ty'+2y=0.
\]
...
\begin{problema}
\textbf{[Facil; Lista 4, Wronskiano e formula de Abel.]}
Sejam $y_1,y_2$ solucoes de
\[
    y''+\tan(t)y'+\cos(t)y=0
\]
...
\begin{problema}
\textbf{[Facil; Lista 4, ressonancia.]}
Resolva
\[
    y''+4y=3\sin(2t),
    \qquad y(0)=0,
...
\begin{problema}
\textbf{[Facil; Lista 4, transformada de Laplace.]}
Encontre a transformada de Laplace das seguintes funcoes.
...
%=====================================================================
\section*{Problemas medio-dificeis}
%=====================================================================
...
\begin{problema}
\textbf{[Medio-dificil; Lista 4, ideia central: conservacao de energia.]}
Considere a equacao nao-linear de Ermakov--Pinney
\[
    y''+y=\frac{1}{y^3},
    \qquad y(0)=1,\quad y'(0)=1.
\]
\begin{enumerate}[label=(\alph*)]
    \item A partir da equacao, obtenha uma equacao de primeira ordem e uma
    quantidade conservada ao longo do tempo.
    \item Use as condicoes iniciais para determinar o valor da quantidade
    conservada.
    \item Resolva a equacao da quantidade conservada e encontre uma solucao
    da equacao inicial.
\end{enumerate}
\end{problema}
...
\begin{problema}
\textbf{[Dificil; Lista 4, equacao diferencial funcional.]}
Seja $a>0$. Encontre todas as funcoes continuamente diferenciaveis
\[
    \varphi:[a,\infty)\to\R
\]
...
\begin{problema}
\textbf{[Dificil; Lista 4, sistemas nao-lineares e contracao.]}
Considere um sistema autonomo
\[
    \frac{\d x_i}{\d t}=F_i(x_1,\dots,x_n),
\]
onde $F=(F_1,\dots,F_n):\R^n\to\R^n$ e um campo vetorial de classe $C^1$.
\begin{enumerate}[label=(\alph*)]
    \item Sejam $U$ e $V$ duas solucoes em $a<t<b$. Supondo que
    \[
        \langle DF(x)z,z\rangle\le 0
    \]
    para todos $x,z\in\R^n$, mostre que $|U(t)-V(t)|^2$ e uma funcao
    decrescente de $t$.
    \item Seja $W(t)$ uma solucao definida para $t>0$. Supondo que
    \[
        \langle DF(x)z,z\rangle\le -|z|^2,
    \]
    mostre que existe $C\in\R^n$ tal que
    \[
...
\begin{problema}
\textbf{[Dificil; Lista 4, transformada de Laplace com condicao integral.]}
Resolva
\[
    y''+4y'+3y=12e^{-2t},
    \qquad y(0)=0,
    \qquad \int_0^\infty y(t)\,\d t=1.
\]
\end{problema}

%=====================================================================
\section*{Problemas ultra-dificeis}
%=====================================================================

\begin{problema}
\textbf{[Ultra-dificil; Lista 4, equacao com retardo.]}
Sejam $a(x)$ e $r(x)$ funcoes positivas e continuas em $[0,\infty)$, e
suponha que
\[
    \liminf_{x\to\infty}\bigl(x-r(x)\bigr)>0.
\]
Suponha que $y(x)$ seja uma funcao continua em toda a reta real,
diferenciavel em $[0,\infty)$, e que satisfaca
\[
    y'(x)=a(x)y(x-r(x))
\]
...
\begin{problema}
\textbf{[Ultra-dificil; Lista 4, sistema nao-linear e numero de extremos.]}
Prove que, se $a_i$ $(i=1,2,3,4)$ sao constantes positivas,
$a_2-a_4>2$ e $a_1a_3-a_2>2$, entao a solucao $(x(t),y(t))$ do sistema
\[
...
\]
tem a propriedade de que a funcao $x(t)$ possui exatamente um maximo local estrito no
intervalo $[0,\infty)$.
\end{problema}
